...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            logging.info("Applying resampling for handling imbalanced dataset.")
            # Import the resampler when needed and apply resampling.
            try:
                ...
                logging.info("Resampling applied to train-test df.")
            except Exception:
                # If resampling package is unavailable or incompatible, continue without resampling.
                logging.warning("Resampling skipped; proceeding without changing class balance")
